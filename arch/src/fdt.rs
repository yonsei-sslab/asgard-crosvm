...
pub enum Error {
    ...
    OutOfOrderEndNode,
    #[error("Sysfs path is not a directory")]
    PathNotDirError,
    #[error("Path to sysfs file has bad format")]
    PathNotValidFormatError,
    ...
    #[error("Failed to read sysfs dir")]
    ReadDirError(io::Error),
    #[error("Failed to read file in sysfs dir")]
